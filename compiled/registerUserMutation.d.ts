...
import { UserInput, AchievementEnum } from './schema';
export declare namespace RegisterUserMutation {
    interface Arguments {
        user: UserInput;
    }
    type registerUser = {
        user: registerUser.user;
        newbiePromoReceived: registerUser.newbiePromoReceived;
    };
...
export interface RegisterUserMutation {
    registerUser: RegisterUserMutation.registerUser;
}
export declare const registerUserMutation: DocumentNode;
