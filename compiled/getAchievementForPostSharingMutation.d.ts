...
export declare namespace GetAchievementForPostSharingMutation {
    interface Arguments {
    }
    type getAchievementForPostSharing = {
        user: getAchievementForPostSharing.user;
        promoReceived: getAchievementForPostSharing.promoReceived;
    };
    namespace getAchievementForPostSharing {
        type user = {
...
export interface GetAchievementForPostSharingMutation {
    getAchievementForPostSharing: GetAchievementForPostSharingMutation.getAchievementForPostSharing;
}
export declare const getAchievementForPostSharingMutation: DocumentNode;
